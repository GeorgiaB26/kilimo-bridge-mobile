...
import type { PendingAgentTaskApprovalView } from '../services/submitAgentTaskApprovalOutbox';

type Props = {
  item: PendingAgentTaskApprovalView;
  pushing?: boolean;
  onPush?: () => void;
  onDismiss: () => void;
};
...
/**
 * Queued agent_tasks approve/reject — distinguishes needs_review from pending/failed.
 */
export function OutboxAgentTaskApprovalCard({ item, pushing, onPush, onDismiss }: Props) {
