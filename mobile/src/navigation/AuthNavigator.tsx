...
import { PlatformRegisterScreen } from '../screens/auth/PlatformRegisterScreen';
...
export function AuthNavigator() {
  return (
    ...
    >
      ...
      <Stack.Screen name="PlatformRegister" component={PlatformRegisterScreen} options={{ title: 'Create account' }} />
