...
async function main(): Promise<void> {
  console.log('Applying Equity SFTP batch schema (018_equity_sftp_batches.sql)…');
  await ensureEquityBatchTables();
  console.log(
    'Done — equity_payment_batches, equity_response_files, and bank_transactions file-channel columns are ready.'
  );
}
